    ...
    <section class="loadout-focus-section">
      <div class="section-heading">
        <div>
          ...
          <p class="section-copy">Your current build now uses the same focus-score model as the suggestions. The score caps skills at their effective max, gives defense only a light weight, and rewards weapon-specific skills for the current weapon type.</p>
        </div>
